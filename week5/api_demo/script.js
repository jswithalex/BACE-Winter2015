...
$.getJSON('http://ip-api.com/json').then(function(locData) {
  ...
  var weatherMapGETurl = 'http://openweathermap.org/data/2.5/weather?q=' + locData.city + ',' + locData.countryCode.toLowerCase() + '&APPID=YOUR_OPEN_WEATHER_MAP
_API_KEY&units=imperial'
